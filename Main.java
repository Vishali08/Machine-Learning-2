...
class Net {
    ...
    public Net(int layers, int[] nodes) {
        this.layers = layers;
        this.nodes = nodes;
        ...
        for (int i = 0; i < layers - 1; i++) {
            for (int n1 = 0; n1 < nodes[i]; n1++) {
                for (int n2 = 0; n2 < nodes[i + 1]; n2++) {
                    ...
                    weights.put(new E(i, n1, i + 1, n2), weight);
                }
            }
        }
    }
...
class E {
    ...
    public E(int l1, int n1, int l2, int n2) {
        this.l1 = l1;
        this.n1 = n1;
        this.l2 = l2;
        this.n2 = n2;
